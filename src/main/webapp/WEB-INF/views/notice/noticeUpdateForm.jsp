...
<main class="container d-flex admin">
	...
	<div class="admin-category">
		<div class="category-box d-flex flex-column">
			...
			<p onclick="location.href='${pageContext.request.contextPath}/qna/qnaList'" style="color: rgb(117, 117, 117); font-weight: normal;">1:1 문의 관리</p>
	...
	<div class="admin-box flex-grow-1">
		...
		<div class="page-upload">
			<div class="notice-form d-flex flex-column">
				<form action="${pageContext.request.contextPath}/notice/noticeUpdate" method="post">
					<div class="notice-title-box">
						<p>
							제목<span>*</span>
						</p>
						<input type="hidden" name="noticeId" value="${notice.noticeId}">
						<input type="text" name="noticeTitle" value="${notice.noticeTitle}" class="notice-form-title" placeholder="제목을 입력해주세요.">
					</div>
					<div class="notice-content-box">
						<p>
							내용<span>*</span>
						</p>
						<textarea class="notice-form-content" name="noticeContent" placeholder="내용을 입력해주세요.">${notice.noticeContent}</textarea>
					</div>
