...
<ul class="category-container">
		<li class="category-item">
			<a class="item-title" onclick="location.href='${pageContext.request.contextPath}/category/snacks'">전체보기</a>
		</li>
		<li class="category-item">
			<a class="item-title" onclick="location.href='${pageContext.request.contextPath}/category/snacks/tbk'">떡볶이</a>
		</li>
		<li class="category-item">
			<a class="item-title" onclick="location.href='${pageContext.request.contextPath}/category/snacks/fry'">튀김</a>
		</li>
		<li class="category-item">
			<a class="item-title active" onclick="location.href='${pageContext.request.contextPath}/category/snacks/frozen'">냉동</a>
		</li>
	</ul>
