...
<ul class="category-container">
		<li class="category-item">
			<a class="item-title" onclick="location.href='${pageContext.request.contextPath}/category/tradDrink'">전체보기</a>
		</li>
		<li class="category-item">
			<a class="item-title" onclick="location.href='${pageContext.request.contextPath}/category/tradDrink/takju'">탁주</a>
		</li>
		<li class="category-item">
			<a class="item-title active" onclick="location.href='${pageContext.request.contextPath}/category/tradDrink/distilled'">증류주</a>
		</li>
		<li class="category-item">
