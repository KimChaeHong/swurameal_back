...
<div class="admin-category">
	<div class="category-box d-flex flex-column">
		<h3>관리자 메뉴</h3>
		<p
			onclick="location.href='${pageContext.request.contextPath}/mgmt/registedList'">상품
			관리</p>
		<p
		...
		<p
			...
			관리</p>
		<p
			onclick="location.href='${pageContext.request.contextPath}/faq/faqList'">FAQ
			관리</p>
	</div>
</div>
<div class="admin-box flex-grow-1">
	<div class="title-box">
		<div class="addButton">
			<p>QnA 관리</p>
			<button data-flag="goods"
				onclick="location.href='${pageContext.request.contextPath}/mgmt/gReg'">작성하기</button>
		</div>
			...
			<div class="accordion-item">
				<h2 class="accordion-header">
					<button
						...
						<p class="post-title">${question.title}</p>
						<p class="flex-grow-1 text-center">${question.questionDate}</p>
						<p id="post-status${i}" class="flex-grow-1 text-center">${question.questionStatus}</p>
					</button>
				</h2>
