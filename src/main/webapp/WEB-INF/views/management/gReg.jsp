...
<div class="admin-box flex-grow-1">
	...
	<div class="page-upload">
		<div class="form-container">
            <form method="post" action="registGoods" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="number" id="goods-price" name="price" >
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="number" id="goods-stockStatus" name="stock" required >
                </div>
                <div class="form-group">
