       ...
       <section id="mainContent">
	        ...
	        <div id="board-container">
		        <div class="notice-box d-flex flex-column">
		            ...
		            <div class="pagination"><button class="page-num active">1</button></div> 
		        </div>  
	        </div>
        </section>
        <!-- 
				...
				<td colspan="5" class="text-center">
					...
					<div>
						...
						<c:if test="${pager.groupNo>1}">
							<a href="boardList?pageNo=${pager.startPageNo-1}" class="btn btn-outline-primary btn-sm">이전</a>
						</c:if>
						...
						<c:if test="${pager.groupNo<pager.totalGroupNo}">
							<a href="boardList?pageNo=${pager.endPageNo+1}" class="btn btn-outline-primary btn-sm">다음</a>
						</c:if>
